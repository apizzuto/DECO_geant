...
for particle in particles:
    for energy in energies:
        ...
        my_command += ' -o ROOTObjectWriter.file_name="{}/{}_theta_90_phi_30.root"'.format(particle, energy)
        my_command += ' -o TextWriter.file_name="{}/{}_theta_90_phi_30.txt"'.format(particle, energy)
        #print(my_command)
